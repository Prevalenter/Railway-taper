...
class ASTModel(nn.Module):
    ...
    def __init__(self, label_dim=527, fstride=10, tstride=10, input_fdim=128, input_tdim=1024,
        ...
        self.match_conv = nn.Conv2d(in_channels=2, out_channels=1, kernel_size=3, padding=1)
...
if __name__ == '__main__':
    ...
    input_tdim = 17
    input_fdim = 71
    ast_mdl = ASTModel(input_tdim=input_tdim, input_fdim=input_fdim, label_dim=2)
    # input a batch of 10 spectrogram, each with 100 time frames and 128 frequency bins
    test_input = torch.rand([10, 2, 17, 71])
